...
const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-2 text-center sm:text-left border-b border-border/20 pb-4 mb-4", className)}
    {...props} />
)
...
const SheetFooter = ({
  ...
  <div
    className={cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 border-t border-border/20 pt-4 mt-4", className)}
    {...props} />
)
